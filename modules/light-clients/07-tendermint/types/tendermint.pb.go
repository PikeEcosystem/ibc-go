...
import (
	fmt "fmt"
	types "github.com/PikeEcosystem/ibc-go/v3/modules/core/02-client/types"
	types1 "github.com/PikeEcosystem/ibc-go/v3/modules/core/23-commitment/types"
...
type ConsensusState struct {
	...
	NextValidatorsHash github_com_PikeEcosystem_tendermint_libs_bytes.HexBytes `protobuf:"bytes,3,opt,name=next_validators_hash,json=nextValidatorsHash,proto3,casttype=github.com/PikeEcosystem/tendermint/libs/bytes.HexBytes" json:"next_validators_hash,omitempty" yaml:"next_validators_hash"`
}

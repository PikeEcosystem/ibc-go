...
HTTPS_GIT := https://github.com/PikeEcosystem/ibc-go.git
...
ldflags = -X github.com/PikeEcosystem/cosmos-sdk/version.Name=sim \
		  -X github.com/PikeEcosystem/cosmos-sdk/version.AppName=simd \
		  -X github.com/PikeEcosystem/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/PikeEcosystem/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X "github.com/PikeEcosystem/cosmos-sdk/version.BuildTags=$(build_tags_comma_sep)"

# DB backend selection
ifeq (cleveldb,$(findstring cleveldb,$(FNSA_BUILD_OPTIONS)))
  ldflags += -X github.com/PikeEcosystem/cosmos-sdk/types.DBBackend=cleveldb
endif
ifeq (badgerdb,$(findstring badgerdb,$(FNSA_BUILD_OPTIONS)))
  ldflags += -X github.com/PikeEcosystem/cosmos-sdk/types.DBBackend=badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(FNSA_BUILD_OPTIONS)))
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/PikeEcosystem/cosmos-sdk/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(FNSA_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
  ldflags += -X github.com/PikeEcosystem/cosmos-sdk/types.DBBackend=boltdb
endif
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/PikeEcosystem/cosmos-sdk/types"
	godoc -http=:6060
...
devdoc-init:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/PikeEcosystem/cosmos-sdk" -w "/go/src/github.com/PikeEcosystem/cosmos-sdk" tendermint/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/PikeEcosystem/cosmos-sdk" -w "/go/src/github.com/PikeEcosystem/cosmos-sdk" devdoc:local bash
